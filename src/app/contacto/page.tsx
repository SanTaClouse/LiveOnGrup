  ...
  return (
    <>
      ...
      <section className="section">
        <Suspense
          fallback={
            <div className="text-brand-faint text-center py-12">
              Cargando formulario…
            </div>
          }
        >
      ...
      <section className="bg-brand-darkgray py-16 px-4 md:px-8">
        <div className="max-w-2xl mx-auto text-center">
          <p className="text-brand-orange font-body text-sm uppercase tracking-widest mb-8">
            Escribinos directamente
          </p>

          <div className="flex flex-col sm:flex-row justify-center gap-8 sm:gap-16 mb-8">
            <div>
              <p className="text-brand-faint font-body text-xs uppercase tracking-widest mb-2">
                Ventas
              </p>
              <a
                href={`mailto:${brand.contact.ventas}`}
                className="block text-white font-heading text-xl md:text-2xl hover:text-brand-orange transition-colors"
              >
          ...
          <a
            ...
            className="inline-flex items-center gap-2 text-brand-muted font-body text-sm hover:text-brand-orange transition-colors"
          >
