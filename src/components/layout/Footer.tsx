    ...
    <footer className="bg-brand-darkgray border-t border-white/5">
      <div className="max-w-6xl mx-auto px-4 md:px-8 py-12 grid grid-cols-1 md:grid-cols-3 gap-10">
        ...
        <div>
          ...
          />
          <p className="text-brand-faint text-sm font-body leading-relaxed">
            {brand.description}
          </p>
        </div>
          ...
          <ul className="flex flex-col gap-2">
            {footerLinks.map(({ href, label }) => (
              <li key={href}>
                <Link
                  href={href}
                  className="text-brand-faint text-sm font-body hover:text-white transition-colors"
                >
                  {label}
                </Link>
              </li>
        ...
        <div>
          ...
          <a
            ...
            className="block text-brand-faint text-sm font-body hover:text-brand-orange transition-colors mb-2"
          >
          ...
          <a
            ...
            className="inline-flex items-center gap-2 text-brand-faint text-sm font-body hover:text-brand-orange transition-colors mb-6"
          >
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="inline-flex items-center gap-2 text-brand-faint text-sm font-body hover:text-brand-orange transition-colors"
          >
            <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
      ...
      <div className="border-t border-white/5 py-4 text-center">
        <p className="text-brand-faint text-xs font-body">
